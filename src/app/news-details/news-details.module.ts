...
@NgModule({
  declarations: [ DialogDetailsContainerComponent, NewsDetailsComponent, ScrollDirective,
  ...
  exports: [DialogDetailsContainerComponent, NewsDetailsComponent,
    MediaSocialComponent, FilesListComponent, CommentsComponent, ScrollDirective,
