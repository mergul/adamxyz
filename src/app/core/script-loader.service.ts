...
export class ScriptLoaderService {
    ...
    public injectScript(renderer: Renderer2, _document: Document, href: string, tag: string, id: string, integrity: string, crossorigin: string) {
        return new Promise( (resolve: (arg0: string) => any, reject: (arg0: string) => any) => {
